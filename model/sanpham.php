<?php    
    function insert_sanpham($tensp,$giasp,$image,$mota,$iddm){
        $sql = "INSERT INTO duanmau2023.sanpham(name,price,img,mota,iddm) values('$tensp','$giasp','$image','$mota','$iddm')";
        pdo_execute($sql);
    }
    ...
    function loadall_sanpham_top10(){
        $sql = "SELECT * FROM duanmau2023.sanpham where 1 order by price  ASC LIMIT 0,10";
        $listsp=pdo_query($sql);    
        return $listsp; 
    }
